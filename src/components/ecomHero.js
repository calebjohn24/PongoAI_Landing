...
function EcomHero() {
  return (
    ...
    <div className="w-full absolute top-4 md:top-6 left-4 md:left-6 z-20 bg-gray-50 shadow-xl h-80 md:h-96 border-2 border-black">
      <div className="p-2">
    ...
    <div className="w-full absolute top-2 md:top-3 left-2 md:left-3 z-10 bg-gray-50 shadow-xl h-80 md:h-96 -translate-y-20 translate-x-2 border-2 border-indigo-500"></div>
    <div className="w-full absolute top-0 z-0 bg-gray-50 shadow-xl h-80 md:h-96 -translate-y-20 translate-x-4 border-2 border-yellow-400"></div>
  </div>
